...
if(!isset($_POST['sub'])){ 
 ...
 if(isset($_POST['sub'])){ 
    ...
    $que = "SELECT * FROM  `sales` WHERE `Date`  BETWEEN '$search' AND '$search1' ";
...
<div class="col-md-12" >
    <div class="panel panel-primary">
        <br> 
        <a href="Add-Sales.php"><button class="btn-success" style="margin-left: 1246px; bottom: auto;">Add Sales</button></a>
        <div class="panel-heading"><i class="fa fa-caret-square-o-up"></i> Sales Report</div>
        <div class="panel-body">
           ...
           <thead>
            <tr>
               ...
               <th style="text-align: center">Reg-Cust-Sale</th>
