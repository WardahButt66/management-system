...
<div class="panel panel-primary">
    <br><br>    <br><br>
    <div style="margin-top: -60px;" class="panel-heading"><i class="fa fa-user"></i>Add Stock</div>
            ...
            <div class="form-body">
                <form class="form-horizontal" method="POST">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9"> 
                            <input type="text" name="price" class="form-control" id="purchases" placeholder="price">
                        </div> 
                    </div>
                    <div class="form-group">
